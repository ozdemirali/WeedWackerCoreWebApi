    ...
    public partial class inital : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployerOffers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmployerOffers_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_EmployerOffers_Works_WorkId",
                        column: x => x.WorkId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployerOffers_UserId",
                table: "EmployerOffers",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployerOffers_WorkId",
                table: "EmployerOffers",
                column: "WorkId");
